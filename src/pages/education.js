...
function education() {
    ...
    return (
        ...
        <Image source={{uri: 'https://www.roffeypark.ac.uk/wp-content/uploads/2018/06/the-7-best-books-to-improve-influencing-skills-2-scaled.jpg'}} style={styles.headerImage}/>
